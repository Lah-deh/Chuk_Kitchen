...
import add from '../assets/Desktop - 4.png'

const Categories = () => {
  return (
    <div>
      <div>
        <h2 className='text-center font-semibold text-[24px] mt-4 sm:mt-15'>
            Popular Categories
        </h2>
        <div className='mx-4 mt-3  sm:grid grid-cols-3 grid-rows-2 gap-4'>
            ...
            <img src={F3} alt='F4' className='w-full mt-4 rounded-lg hidden sm:block'/>
            <img src={F1} alt='F1' className='w-full mt-4 rounded-lg hidden sm:block'/>
            <img src={F2} alt='F2' className='w-full mt-4 rounded-lg hidden sm:block'/>
            <p className='text-[#1E88E5] text-[16px] font-semi-medium mt-5 text-center mb-17 sm:hidden'>
                <Link to='/menu'>View All Categories</Link>
            </p>
        </div>
      </div>
      <h2 className='text-center text-[30px] font-medium sm:mt-20'>
                Chef's Specials
      </h2>
      <div className='sm:grid grid-cols-3 grid-rows-2 '>
       ...
       <p className='text-[#1E88E5] text-[16px] font-semi-medium mt-5 text-center mb-17 sm:hidden'>
        ...
        <img src={Advert} alt='Advert' className='w-full sm:hidden' />
        <img src={add} alt='Advert' className='w-full hidden sm:block mt-17' />
    </div>
  )
}
